...
const SVGPieces: Record<string, React.ReactNode> = {
  // WHITE PIECES
  'w-p': (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" preserveAspectRatio="xMidYMid meet" className="w-full h-full drop-shadow-sm">
  ...
  'b-q': (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" preserveAspectRatio="xMidYMid meet" className="w-full h-full drop-shadow-sm">
      <g fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M11 38.5a35 35 1 0 0 23 0" fill="none" strokeLinecap="butt" stroke="#ececec" />
